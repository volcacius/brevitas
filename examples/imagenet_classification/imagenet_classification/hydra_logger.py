...
VAL_ = 'val_'
METER_SUFFIX = '_meter'
EMA_METER_SUFFIX = '_ema' + METER_SUFFIX
AVG_SUFFIX = '_avg'
...
VAL_LOSS_EMA_METER = VAL_ + LOSS_LOG_KEY + EMA_METER_SUFFIX
VAL_TOP1_EMA_METER = VAL_ + TOP1_LOG_KEY + EMA_METER_SUFFIX
VAL_TOP5_EMA_METER = VAL_ + TOP5_LOG_KEY + EMA_METER_SUFFIX
